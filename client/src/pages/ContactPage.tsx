      ...
      <div className="flex flex-col md:flex-row w-full max-w-6xl mx-auto mt-8 mb-16 rounded-lg overflow-hidden shadow-lg">
        ...
        <div className="md:w-1/2 bg-cyan-100 text-gray-700 p-8 flex flex-col justify-center">
          ...
          <p className="text-gray-500 mb-8">
            Have a question? Reach out to us using the contact information
            below.
          </p>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-lg">
                Center Email: auroraonca@codeninjas.com
              </span>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              <span className="text-lg">
                Event Specific Email: events.cnaurora@codeninjas.com
              </span>
            </div>
          ...
          <div className="flex gap-2 mt-10">
            {" "}
            {/* Changed to flex row with gap */}
            <a
              href="https://www.facebook.com/codeninjasauroraon/"
            ...
            <a
              href="https://www.instagram.com/codeninjasaurora/"
              className="hover:opacity-75"
            >
              <span className="[&>svg]:h-6 [&>svg]:w-6">
                <svg
            ...
            <a
              href="https://www.tiktok.com/@codeninjasaurora"
              className="hover:opacity-75"
            >
              <span className="[&>svg]:h-6 [&>svg]:w-6">
                <svg
