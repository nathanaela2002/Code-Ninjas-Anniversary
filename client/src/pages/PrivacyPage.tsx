      ...
      <main className="max-w-6xl mx-auto px-4 py-8">
        ...
        >
          ...
          <p className="text-gray-700 leading-relaxed">
            Thank you for participating in our 2nd Year Anniversary Challenge,
            which includes web-based registration, event websites, and email. We
            respect your privacy and are committed to safeguarding your personal
        ...
        >
          ...
          <ul className="list-disc list-inside text-gray-700 mb-4 leading-relaxed">
            <li>
              Facilitating your registration and participation in the Event.
            </li>
            <li>
            ...
            <li>
              Sending marketing and promotional materials, where permitted by
              law.
            </li>
        ...
        >
          ...
          <p className="text-gray-700 leading-relaxed">
            ...
            <strong>events.cnaurora@codeninjas.com</strong>. By continuing to
